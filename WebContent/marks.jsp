	...
	<form action="MarksServlet" method="post">
		<div style="padding-top: 20px;">
			<label style="padding-left: 60px; font-size: 20px;"
				class="col-md-1 control-label">Rollno<span class="required">*</span></label>
				<div style="padding-left: 20px; width: 150px;"class="col-md-1 inputGroupContainer">
				 <input type="number" class="text form-control" placeholder ="roll"name="roll">
			</div>
			...
			<thead>
				<tr>
					<th scope="col">Name</th>
					 <th scope="col"><c:out value="${nList.key}"></c:out></th>
				</tr>
			</thead>
			
			<tbody>
				<tr>
					<th scope="row"><c:out value="${nList.value}"></c:out></th>
